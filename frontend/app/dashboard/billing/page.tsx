...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['256 MB cache', '1,000 ops/sec', 'LRU eviction', 'Community support'] },
  { name: 'Pro', price: '$49/mo', features: ['16 GB cache', '100,000 ops/sec', 'TinyLFU eviction', 'Markov oracle prefetch', '50,000 API calls/hr', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited cache', 'Unlimited ops/sec', 'Multi-region', 'Custom eviction policies', 'SLA 99.99%', 'Dedicated support'] },
];
